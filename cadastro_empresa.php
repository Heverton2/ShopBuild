					...
					<div class="login_form_inner p-5">
						<form class="row contact_form" action="" method="POST">
							...
							<div class="col-12 col-md-12 form-group input-group-icon">
								...
								<input type="text" class="form-control pl-5" placeholder="Nome da empresa" id="nome"
									name="nome">
							</div>
							<div class="col-12 col-md-6 form-group input-group-icon">
								<div class="icon ml-2"><i class="fa fa-id-card" aria-hidden="true"></i></div>
								<input type="text" class="form-control pl-5" placeholder="CNPJ" id="cnpj" name="cnpj"
									maxlength="14">
							</div>
							<div class="col-12 col-md-6 form-group input-group-icon">
								<div class="icon ml-2"><i class="fa fa-phone" aria-hidden="true"></i></div>
								<input type="email" class="form-control pl-5" placeholder="Telefone" id="telefone"
									name="telefone">
							</div>
							<div class="col-12 col-md-12 form-group input-group-icon">
