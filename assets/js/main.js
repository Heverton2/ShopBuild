...
$(document).ready(function () {
  ...
  $.get("https://servicodados.ibge.gov.br/api/v1/localidades/estados/", function (data) {
    ...
    for (var i = 0; i < data.length; i++){
      estados += "<option id='" + data[i].id +"' value='" + data[i].nome + "'>" + data[i].nome + "</option>";
    }
    $('#uf').append(estados);
});

$("#uf").change(function () {
  var uf = $("#uf option:selected").attr("id")   
  $('#cidade').empty();
  $.get("https://servicodados.ibge.gov.br/api/v1/localidades/estados/" + uf + "/municipios", function (data) {
    var cidades = "";
    for (i = 0; i < data.length; i++){ 
      cidades += "<option id='" + data[i].id +"' value='" + data[i].nome + "'>" + data[i].nome + "</option>";
    }
